...
const SERVICE_CATEGORIES = {
  Maintenance: ["Oil Change", "General Service", "Brake Inspection", "Tire Rotation"],
  Repair: ["Engine Repair", "Brake Repair", "Battery Replacement", "Transmission Repair"],
  Inspection: ["Pre-purchase Inspection", "Emission Test", "Insurance Inspection"],
  Detailing: ["Car Wash", "Interior Cleaning", "Wax Coating", "Engine Detailing"],
}
...
export default function ServiceStep({ data, onNext, onBack }: ServiceStepProps) {
  ...
  const serviceTypes = SERVICE_CATEGORIES[formData.category as keyof typeof SERVICE_CATEGORIES] || []
