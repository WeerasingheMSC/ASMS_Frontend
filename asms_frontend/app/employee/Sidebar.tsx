...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    else if (pathname.startsWith("/employee/team-analysis")) setActiveLabel("Team Analysis");
  ...
  const nav = [
    ...
    { href: "/employee/team-analysis", label: "Team Analysis", icon: <GrDocumentPerformance className="mr-2 text-2xl" /> },
